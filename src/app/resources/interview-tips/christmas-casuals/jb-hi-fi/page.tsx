...
export const metadata: Metadata = {
  title: 'EP4. JB Hi-Fi Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
  description: 'Master JB Hi-Fi Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
  keywords: 'JB Hi-Fi jobs Australia, Christmas Casual jobs, retail interview tips, holiday employment 2025, JB Hi-Fi interview tips, Australian retail jobs, fresh interview tips, Héra AI career guide, AI career agent, job interview preparation Australia',
  openGraph: {
    title: 'EP4. JB Hi-Fi Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
    description: 'Master JB Hi-Fi Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
    type: 'article',
...
export default function JBHifiChristmasCasualPage() {
  const jsonLd = {
    ...
    "@type": "TechArticle",
    "headline": "EP4. JB Hi-Fi Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide",
    "description": "Master JB Hi-Fi Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.",
    "author": {
      "@type": "Organization",
      "name": "Héra AI",
