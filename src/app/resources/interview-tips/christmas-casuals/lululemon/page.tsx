...
export const metadata: Metadata = {
  title: 'EP1. Lululemon Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
  description: '🎄 Master Lululemon Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
  keywords: 'Lululemon jobs Australia, Christmas Casual jobs, retail interview tips, holiday employment 2025, Lululemon interview tips, Australian retail jobs, fresh interview tips, Héra AI career guide, AI career agent, job interview preparation Australia',
  openGraph: {
    title: 'EP1. Lululemon Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
    description: '🎄 Master Lululemon Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
    type: 'article',
    url: 'https://www.heraai.net.au/resources/interview-tips/christmas-casuals/lululemon',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lululemon Christmas Casual Interview Tips Australia 2025',
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.heraai.net.au/resources/interview-tips/christmas-casuals/lululemon',
  },
  robots: {
    index: true,
    follow: true,
...
export default function LululemonChristmasCasualPage() {
  ...
  const jsonLd = {
    ...
    "@type": "TechArticle",
    "headline": "EP1. Lululemon Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide",
    "description": "Master Lululemon Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.",
    "author": {
      "@type": "Organization",
      "name": "Héra AI",
    ...
    "mainEntityOfPage": "https://www.heraai.net.au/resources/interview-tips/christmas-casuals/lululemon",
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="mt-14 pt-4 px-6">
          <nav className="text-sm text-gray-500">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-900">Lululemon</span>
          </nav>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <section className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link href="/resources/interview-tips/christmas-casuals" className="block p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">All Christmas Casual Interview Tips</h3>
                <p className="text-gray-600">Browse all our Christmas Casual interview guides from top Australian retailers.</p>
              </Link>
              <Link href="/resources/interview-tips/christmas-casuals/david-jones" className="block p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
