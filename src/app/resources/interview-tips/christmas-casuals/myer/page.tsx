...
export const metadata: Metadata = {
  title: 'EP3. Myer Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
  description: 'Master Myer Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
  keywords: 'Myer jobs Australia, Christmas Casual jobs, retail interview tips, holiday employment 2025, Myer interview tips, Australian retail jobs, fresh interview tips, Héra AI career guide, AI career agent, job interview preparation Australia',
  openGraph: {
    title: 'EP3. Myer Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
    description: 'Master Myer Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
    type: 'article',
...
export default function MyerChristmasCasualPage() {
  ...
  const jsonLd = {
    ...
    "@type": "TechArticle",
    "headline": "EP3. Myer Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide",
    "description": "Master Myer Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.",
    "author": {
      "@type": "Organization",
      "name": "Héra AI",
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <footer className="mt-12 pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-500">
              Written by Héra AI Editorial Team | Updated October 10, 2025 | 
