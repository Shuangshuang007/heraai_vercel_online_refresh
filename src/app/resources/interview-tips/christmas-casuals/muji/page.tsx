...
export const metadata: Metadata = {
  title: 'EP8. MUJI Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
  description: 'Master MUJI Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
  keywords: 'MUJI jobs Australia, Christmas Casual retail, MUJI interview tips, holiday employment 2025, MUJI interview tips, Australian retail jobs, fresh interview tips, Héra AI career guide, AI career agent, job interview preparation Australia',
  openGraph: {
    title: 'EP8. MUJI Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
    description: 'Master MUJI Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
...
const jsonLd = {
  ...
  '@type': 'TechArticle',
  headline: 'EP8. MUJI Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
  description: 'Master MUJI Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
  author: {
    '@type': 'Organization',
    name: 'Héra AI',
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          <header className="mb-8">
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-500 mb-6">
              ...
              <span>👥 By: Héra AI Editorial Team</span>
            </div>
          ...
          <footer className="mt-12 pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-500">
              Written by Héra AI Editorial Team | Updated September 10, 2025 |
