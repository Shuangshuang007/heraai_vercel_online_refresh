...
export const metadata: Metadata = {
  title: 'EP2. David Jones Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
  description: 'Master David Jones Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
  keywords: 'David Jones jobs Australia, Christmas Casual jobs, retail interview tips, holiday employment 2025, David Jones interview tips, Australian retail jobs, fresh interview tips, Héra AI career guide, AI career agent, job interview preparation Australia',
  openGraph: {
    title: 'EP2. David Jones Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide',
    description: 'Master David Jones Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.',
    type: 'article',
...
export default function DavidJonesChristmasCasualPage() {
  ...
  const jsonLd = {
    ...
    "@type": "TechArticle",
    "headline": "EP2. David Jones Christmas Casual Interview Tips Australia 2025 | Héra AI Career Guide",
    "description": "Master David Jones Christmas Casual interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for all jobs in Australia.",
    "author": {
      "@type": "Organization",
      "name": "Héra AI",
