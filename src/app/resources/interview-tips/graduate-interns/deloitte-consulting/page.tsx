...
export const metadata: Metadata = {
  title: 'Deloitte Consulting Vacationer Program Interview Guide Australia 2025 | Héra AI Career Guide',
  description: '🏢 Master Deloitte Consulting Vacationer Program interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for Strategy, Operations, and Tech Consulting roles in Australia.',
  keywords: 'Deloitte Consulting jobs Australia, Vacationer Program, graduate interview tips, Australian graduate jobs, consulting interview tips, strategy consulting Australia, operations consulting Australia, Héra AI career guide, AI career agent, job interview preparation Australia',
  openGraph: {
    title: 'Deloitte Consulting Vacationer Program Interview Guide Australia 2025 | Héra AI Career Guide',
    description: '🏢 Master Deloitte Consulting Vacationer Program interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for Strategy, Operations, and Tech Consulting roles in Australia.',
    type: 'article',
    url: 'https://www.heraai.net.au/resources/interview-tips/graduate-interns/deloitte-consulting',
    images: [
      {
        url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80',
        width: 1200,
        height: 630,
        alt: 'Deloitte Consulting Vacationer Program Interview Guide Australia 2025',
      },
    ],
  },
  twitter: {
    ...
    title: 'Deloitte Consulting Vacationer Program Interview Guide Australia 2025 | Héra AI Career Guide',
    description: '🏢 Master Deloitte Consulting Vacationer Program interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for Strategy, Operations, and Tech Consulting roles in Australia.',
    images: ['https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80'],
  },
  alternates: {
    canonical: 'https://www.heraai.net.au/resources/interview-tips/graduate-interns/deloitte-consulting',
  },
  robots: {
    index: true,
    follow: true,
...
export default function DeloitteConsultingPage() {
  const jsonLd = {
    "@context": "https://schema.org/",
    "@type": "TechArticle",
    "headline": "Deloitte Consulting Vacationer Program Interview Guide Australia 2025 | Héra AI Career Guide",
    "description": "Master Deloitte Consulting Vacationer Program interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for Strategy, Operations, and Tech Consulting roles in Australia.",
    "author": {
      "@type": "Organization",
      "name": "Héra AI",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.heraai.net.au/resources/interview-tips/graduate-interns/deloitte-consulting"
    },
    "image": {
      "@type": "ImageObject",
      "url": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="mt-14 pt-4 px-6">
          <nav className="text-sm text-gray-500">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-900">Deloitte Consulting</span>
          </nav>
        </div>
          ...
          <article className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="p-8 border-b border-gray-200">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Deloitte Consulting Vacationer Program Interview Guide
              </h1>
              <p className="text-xl text-gray-600 mb-6">
                Ready to dive into the world of consulting? Deloitte's Consulting Vacationer Program offers hands-on experience across Strategy, Operations, and Tech Consulting streams. Here's your complete guide to acing the interview process.
              </p>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Deloitte Consulting</span>
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Strategy Consulting</span>
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Operations Consulting</span>
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Tech Consulting</span>
              </div>
            </div>
            ...
            <div className="p-8">
              <div className="prose prose-lg max-w-none">
                <section className="mb-8">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Track B — Consulting (Strategy/Operations/Tech Consulting)</h2>
                  
                  <div className="bg-blue-50 p-6 rounded-lg mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">What to expect:</h3>
                    <p className="text-gray-700 mb-4">
                      Flow: application → psychometric/immersive test → video interview (3 questions, multiple takes often allowed) → assessment centre (group case) → 30-min manager interview; some teams share a pre-read case for a short presentation.
                    </p>
                  </div>

                  <div className="bg-green-50 p-6 rounded-lg mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Case & interview focus:</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-2">
                        <span className="text-green-600 mt-1">•</span>
                        <span>Client problem framing, structure, stakeholder management, and concise recommendations</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-600 mt-1">•</span>
                        <span>Expect a group case followed by an individual behavioral/fit interview</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-yellow-50 p-6 rounded-lg mb-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Short 5-minute case presentation (provided beforehand)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-yellow-600 mt-1">•</span>
                        <span>Behavioral: ownership, teamwork under ambiguity, learning from failure</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-green-50 p-6 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-2">
                        <span className="text-green-600 mt-1">•</span>
                        <span>Use a clear structure (Problem → Options → Recommendation → Risks/Next steps)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-600 mt-1">•</span>
                        <span>Demonstrate client-friendly communication and teamwork under time pressure</span>
                      </li>
                    </ul>
                  </div>
                </section>
