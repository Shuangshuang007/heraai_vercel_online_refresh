...
export const metadata: Metadata = {
  title: 'PwC Consulting Vacationer Program Interview Guide Australia 2025 | Héra AI Career Guide',
  description: '💼 Master PwC Consulting Vacationer Program interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for Strategy, Operations, and Deals roles in Australia.',
  keywords: 'PwC Consulting jobs Australia, Vacationer Program, graduate interview tips, Australian graduate jobs, consulting interview tips, strategy consulting Australia, operations consulting Australia, Héra AI career guide, AI career agent, job interview preparation Australia',
  openGraph: {
    title: 'PwC Consulting Vacationer Program Interview Guide Australia 2025 | Héra AI Career Guide',
    description: '💼 Master PwC Consulting Vacationer Program interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for Strategy, Operations, and Deals roles in Australia.',
    type: 'article',
    url: 'https://www.heraai.net.au/resources/interview-tips/graduate-interns/pwc-consulting',
    images: [
      {
        url: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80',
        width: 1200,
        height: 630,
        alt: 'PwC Consulting Vacationer Program Interview Guide Australia 2025',
      },
    ],
  },
  twitter: {
    ...
    title: 'PwC Consulting Vacationer Program Interview Guide Australia 2025 | Héra AI Career Guide',
    description: '💼 Master PwC Consulting Vacationer Program interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for Strategy, Operations, and Deals roles in Australia.',
    images: ['https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80'],
  },
  alternates: {
    canonical: 'https://www.heraai.net.au/resources/interview-tips/graduate-interns/pwc-consulting',
  },
  robots: {
    index: true,
    follow: true,
...
export default function PwCConsultingPage() {
  const jsonLd = {
    "@context": "https://schema.org/",
    "@type": "TechArticle",
    "headline": "PwC Consulting Vacationer Program Interview Guide Australia 2025 | Héra AI Career Guide",
    "description": "Master PwC Consulting Vacationer Program interviews with expert tips from students who got hired. Real Q&As, preparation strategies, and insider advice for Strategy, Operations, and Deals roles in Australia.",
    "author": {
      "@type": "Organization",
      "name": "Héra AI",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.heraai.net.au/resources/interview-tips/graduate-interns/pwc-consulting"
    },
    "image": {
      "@type": "ImageObject",
      "url": "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="mt-14 pt-4 px-6">
          <nav className="text-sm text-gray-500">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-900">PwC Consulting</span>
          </nav>
        </div>
          ...
          <article className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="p-8 border-b border-gray-200">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                PwC Consulting Vacationer Program Interview Guide
              </h1>
              <p className="text-xl text-gray-600 mb-6">
                Ready to solve complex business challenges? PwC's Consulting and Deals Vacationer Program immerses you in real client projects in strategy, operations, transformation, and deals advisory. The program lasts 6–8 weeks and can lead directly to a graduate offer.
              </p>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">PwC Consulting</span>
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Strategy</span>
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Operations</span>
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Deals Advisory</span>
              </div>
            </div>
            ...
            <div className="p-8">
              <div className="prose prose-lg max-w-none">
                <section className="mb-8">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Track B — Consulting / Deals / Strategy</h2>
                  
                  <div className="bg-blue-50 p-6 rounded-lg mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">🎓 Program Overview</h3>
                    <p className="text-gray-700 mb-4">
                      PwC's Consulting and Deals Vacationer Program immerses you in real client projects in strategy, operations, transformation, and deals advisory.
