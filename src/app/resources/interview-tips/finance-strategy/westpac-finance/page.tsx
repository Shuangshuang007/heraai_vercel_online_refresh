...
export const metadata: Metadata = {
  title: 'EP5. Top 10 Interview Questions & Tips for Finance/Accounting Roles with Westpac Australia 2025 | Héra AI Career Guide',
  ...
  keywords: 'Westpac Finance jobs Australia, Westpac Accounting interview tips, Westpac Finance roles, Australian Finance jobs, Westpac interview preparation, Finance interview questions Australia, Héra AI career guide, AI career agent, job interview preparation Australia',
  openGraph: {
    title: 'EP5. Top 10 Interview Questions & Tips for Finance/Accounting Roles with Westpac Australia 2025 | Héra AI Career Guide',
    description: '🇦🇺 Master Westpac Finance and Accounting interviews with expert tips from professionals who got hired. Real Q&As, preparation strategies, and insider advice for Finance roles in Australia.',
    type: 'article',
    url: 'https://www.heraai.net.au/resources/interview-tips/finance-strategy/westpac-finance',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Westpac Finance Interview Questions Australia 2025',
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.heraai.net.au/resources/interview-tips/finance-strategy/westpac-finance',
  },
  robots: {
    index: true,
    follow: true,
...
export default function WestpacFinancePage() {
const jsonLd = {
    "@context": "https://schema.org/",
    "@type": "TechArticle",
    "headline": "EP5. Top 10 Interview Questions & Tips for Finance/Accounting Roles with Westpac Australia 2025 | Héra AI Career Guide",
    "description": "Master Westpac Finance and Accounting interviews with expert tips from professionals who got hired. Real Q&As, preparation strategies, and insider advice for Finance roles in Australia.",
    "author": {
      "@type": "Organization",
      "name": "Héra AI",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.heraai.net.au/resources/interview-tips/finance-strategy/westpac-finance"
    },
    "image": {
      "@type": "ImageObject",
      "url": "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="mt-14 pt-4 px-6">
          <nav className="text-sm text-gray-500">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-900">Westpac Finance</span>
          </nav>
          </div>
          ...
          <article className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="p-8 border-b border-gray-200">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                EP5. Top 10 Interview Questions & Tips for Finance/Accounting Roles with Westpac
              </h1>
              <p className="text-xl text-gray-600 mb-6">
                Master Westpac Finance and Accounting interviews with expert tips from professionals who got hired. Real Q&As, preparation strategies, and insider advice for Finance roles in Australia.
              </p>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Westpac Finance</span>
            ...
            <div className="p-8">
              <div className="prose prose-lg max-w-none">
                <section className="mb-8">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Top 10 Westpac Finance Interview Questions & Expert Tips</h2>
                  
                  <div className="bg-blue-50 p-6 rounded-lg mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">🎯 Interview Overview</h3>
                    <p className="text-gray-700 mb-4">
                      Westpac's Finance and Accounting interview process is designed to assess your technical skills, analytical thinking, and cultural fit. 
                  ...
                  <div className="mb-8">
                    ...
                    <div className="bg-green-50 p-6 rounded-lg mb-4">
                      ...
                      <ul className="space-y-2 text-gray-700">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-green-600 mt-1">•</span>
                          <span>Connect Westpac's client base and projects to your career aspirations</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-green-600 mt-1">•</span>
                          <span>Show knowledge of Westpac's recent achievements or initiatives</span>
                        </li>
                      </ul>
              </div>
                  ...
                  <ul className="space-y-2 text-gray-700">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-green-600 mt-1">•</span>
                          <span>Connect your achievement to how it would benefit Westpac</span>
                        </li>
                  </ul>
                </div>
